            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/contas/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/contas/edit/'+row.id">
                ...
                <td>                 <div class="col-12"> <strong>Data Ocorrido  : </strong>{{row.data_ocorrido}}</div>
                 ...
                 <div class="col-12"> <strong>Modalidade  : </strong>{{row.modalidade}}</div>
                ...
                <td>                 <div class="col-12"> <strong>Parcelas  : </strong>{{row.parcelas}}</div>
</td>
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await contasService.list(this.search);
