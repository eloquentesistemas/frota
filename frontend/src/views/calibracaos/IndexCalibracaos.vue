            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/calibracaos/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/calibracaos/edit/'+row.id">
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await calibracaosService.list(this.search);
        ...
        async deleteRow(id){
            let calibracaosService = new calibracaoService();
            let dataRow = await calibracaosService.delete(id);
