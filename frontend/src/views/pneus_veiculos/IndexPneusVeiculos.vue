            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/pneus_veiculos/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/pneus_veiculos/edit/'+row.id">
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await pneus_veiculosService.list(this.search);
        ...
        async deleteRow(id){
            let pneus_veiculosService = new pneus_veiculoService();
            let dataRow = await pneus_veiculosService.delete(id);
