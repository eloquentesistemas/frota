            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/veiculos/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/veiculos/edit/'+row.id">
                ...
                <td>                 <div class="col-12"> <strong>Nome  : </strong>{{row.nome}}</div>
                 <div class="col-12"> <strong>Placa  : </strong>{{row.placa}}</div>
                 <div class="col-12"> <strong>Cor  : </strong>{{row.cor}}</div>
                 <div class="col-12"> <strong>Vencimento Documento  : </strong>{{row.vencimento_documento}}</div>
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await veiculosService.list(this.search);
        ...
        async deleteRow(id){
            let veiculosService = new veiculoService();
            let dataRow = await veiculosService.delete(id);
