            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/cidades/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/cidades/edit/'+row.id">
                ...
                <td>                 <div class="col-12"> <strong>Codigo  : </strong>{{row.codigo}}</div>
                 <div class="col-12"> <strong>Nome  : </strong>{{row.nome}}</div>
                 <div class="col-12"> <strong>Uf  : </strong>{{row.uf}}</div>
</td>
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await cidadesService.list(this.search);
        ...
        async deleteRow(id){
            let cidadesService = new cidadeService();
            let dataRow = await cidadesService.delete(id);
