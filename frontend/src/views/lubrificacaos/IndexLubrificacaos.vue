            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/lubrificacaos/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/lubrificacaos/edit/'+row.id">
                ...
                <td>                 <div class="col-12"> <strong>Data : </strong>{{row.data}}</div>
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await lubrificacaosService.list(this.search);
        ...
        async deleteRow(id){
            let lubrificacaosService = new lubrificacaoService();
            let dataRow = await lubrificacaosService.delete(id);
