      ...
      <div class="col-12">
        <div class="row">
          <div class="col-12 ps-4 pt-3 ">
            ...
            <div class="float-end">
              <button-widget cor="azul" href="/abastecimento_veiculos/create" tamanho="M">
                Adicionar
              </button-widget>
            </div>
          </div>
            ...
            <td>
              <div class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li>
                    <router-link class="dropdown-item" :to="'/abastecimento_veiculos/edit/'+row.id">
...
export default {
  ...
  methods: {
    async list() {
      ...
      let dataRow = await abastecimento_veiculosService.list(this.search);
    ...
    async deleteRow(id) {
      let abastecimento_veiculosService = new abastecimento_veiculoService();
      let dataRow = await abastecimento_veiculosService.delete(id);
