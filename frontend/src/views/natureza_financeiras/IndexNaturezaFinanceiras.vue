            ...
            <div class="col-12">
                <div class="row">
                    <div class="col-12 ps-4 pt-3 ">
                        ...
                        <div class="float-end">
                            <button-widget cor="azul" href="/natureza_financeiras/create" tamanho="M">
                                Adicionar
                            </button-widget>
                        </div>
                    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <router-link class="dropdown-item" :to="'/natureza_financeiras/edit/'+row.id">
...
export default {
    ...
    methods: {
        async list() {
           ...
           let dataRow = await natureza_financeirasService.list(this.search);
        ...
        async deleteRow(id){
            let natureza_financeirasService = new natureza_financeiraService();
            let dataRow = await natureza_financeirasService.delete(id);
